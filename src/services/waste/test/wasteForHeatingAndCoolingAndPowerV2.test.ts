...
test.only('main', async () => {
  const params = {
    ...
    cdd: [
      { value: 2025, date: new Date(2013, 0, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1984, date: new Date(2013, 1, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2000, date: new Date(2013, 2, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2324, date: new Date(2013, 3, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2230, date: new Date(2013, 4, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2345, date: new Date(2013, 5, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2025, date: new Date(2013, 6, 1), siteId: 1, kind: 'CDD' as const },
      { value: 2011, date: new Date(2013, 7, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1655, date: new Date(2013, 8, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1624, date: new Date(2013, 9, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1630, date: new Date(2013, 10, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1680, date: new Date(2013, 11, 1), siteId: 1, kind: 'CDD' as const },
    ],
    ...
    nextCdd: [
      { value: 2166.5, date: new Date(2014, 0, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1904.3, date: new Date(2014, 1, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1996.7, date: new Date(2014, 2, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1799.9, date: new Date(2014, 3, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1734.6, date: new Date(2014, 4, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1546.1, date: new Date(2014, 5, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1435.9, date: new Date(2014, 6, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1441, date: new Date(2014, 7, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1526.8, date: new Date(2014, 8, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1723, date: new Date(2014, 9, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1792.4, date: new Date(2014, 10, 1), siteId: 1, kind: 'CDD' as const },
      { value: 1976.6, date: new Date(2014, 11, 1), siteId: 1, kind: 'CDD' as const },
    ],
  ...
  const result = WasteCalculationV2.wasteForHeatingAndCoolingAndPower(params);
  expect(result.length).toBe(12);
  expect(result[0].waste).toBe(2216.209573);
  expect(result[1].waste).toBe(-6630.667749);
  expect(result[2].waste).toBe(-4758.168494);
  expect(result[3].waste).toBe(-2583.783977);
  expect(result[4].waste).toBe(-8638.25245);
  expect(result[5].waste).toBe(-5808.732453);
  expect(result[6].waste).toBe(23026.15942);
  expect(result[7].waste).toBe(-9920.925295);
  expect(result[8].waste).toBe(-2633.392587);
  expect(result[9].waste).toBe(146.961296);
  expect(result[10].waste).toBe(-291.013497);
  expect(result[11].waste).toBe(5285.770667);
});
