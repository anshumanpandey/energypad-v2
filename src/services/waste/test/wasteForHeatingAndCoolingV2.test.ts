...
test.only('main', async () => {
  ...
  expect(result[0].waste).toBe(1054.009117);
  expect(result[1].waste).toBe(-8147.894881);
  expect(result[2].waste).toBe(-4361.308687);
  expect(result[3].waste).toBe(-3050.598645);
  expect(result[4].waste).toBe(-7999.566517);
  expect(result[5].waste).toBe(-6734.64636);
  expect(result[6].waste).toBe(24032.962963);
  expect(result[7].waste).toBe(-9423.762307);
  expect(result[8].waste).toBe(-1322.952093);
  expect(result[9].waste).toBe(1605.023989);
  expect(result[10].waste).toBe(625.194274);
  expect(result[11].waste).toBe(5846.704762);
});
