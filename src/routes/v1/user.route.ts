...
userRoutes.post("/address", requestValidator({ body: schema.components.requestBodies.CreateUser.content["application/json"].schema as AllowedSchema }), (request, response) => {
  /**
