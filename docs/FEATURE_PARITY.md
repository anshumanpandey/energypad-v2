...
| FP15 | Utility five-sheet and named-sheet imports | Replace | Versioned mapping templates and batch pipeline | 2–3 | Consumption/emissions/targets/setpoints/drivers covered; rows outside a correction batch remain intact. |
