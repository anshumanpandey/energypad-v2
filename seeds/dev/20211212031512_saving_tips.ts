...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('EnergySavingTips').insert([
    ...
    { text: 'Turn off unused radiators ', category: 'Heating ', imageUrl: null },
    {
    ...
    { text: 'Close all windows during heating to prevent air infiltration ', category: 'Heating ', imageUrl: null },
    { text: 'Shut doors during heating properly to prevent air infiltration ', category: 'Heating ', imageUrl: null },
    { text: 'Draft proof doors ', category: 'Heating ', imageUrl: null },
    { text: 'Check that insulation on building fabrics are in good condition ', category: 'Heating ', imageUrl: null },
    { text: 'Check that there are no hot water leaks  ', category: 'Heating ', imageUrl: null },
    { text: 'Use water efficiently and cut back on hot water use ', category: 'Heating ', imageUrl: null },
    { text: ' Check that radiator are free of obstructions at all time ', category: 'Heating ', imageUrl: null },
    { text: 'Reduce heating setpoint by 1 degree if possible ', category: 'Heating ', imageUrl: null },
    { text: 'Match heating supply to the building with operating times ', category: 'Heating ', imageUrl: null },
    {
      text: 'Raise energy awareness more often to users. This can be via e-mail, face-to-face, webinars or workshops. ',
      category: 'Power',
      imageUrl: null,
    },
    { text: 'Turn off unused lights off ', category: 'Power', imageUrl: null },
    { text: 'Walk through to turn off lights  ', category: 'Power', imageUrl: null },
    {
    ...
    { text: 'Unplug unused servers ', category: 'Power', imageUrl: null },
    { text: 'Check that to there are no water leaks  ', category: 'Power', imageUrl: null },
    { text: 'Reduce office use and intensive activities during peak times ', category: 'Power', imageUrl: null },
    {
    ...
    { text: 'Shut computers off completely when not in use  ', category: 'Power', imageUrl: null },
    {
      text: 'Switch off lights or reduce the number of lights on when daylighting can be harvested ',
      category: 'Power',
      imageUrl: null,
    },
    { text: 'Clean lighting fixtures to improve light reflectance ', category: 'Power', imageUrl: null },
    { text: 'Clean device screenplays ', category: 'Power', imageUrl: null },
  ]);
}
