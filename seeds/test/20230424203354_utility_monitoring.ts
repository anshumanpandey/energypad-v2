...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('UtilityMonitoring').insert([
    buildFakeUtilityMonitoring({ id: 1000, date: '2020-01-01', carbon: 22, fuelSourceId: 2, siteId: 603 }),
    buildFakeUtilityMonitoring({ id: 1002, date: '2020-01-01', carbon: 10, fuelSourceId: 3, siteId: 603 }),
    buildFakeUtilityMonitoring({ id: 1004, date: '2020-03-01', carbon: 10, fuelSourceId: 4, siteId: 603 }),
  ]);
}
